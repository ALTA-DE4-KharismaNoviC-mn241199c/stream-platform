...
def load_avro_schema_from_file():
    ...
    value_schema = avro.load('/home/rismanovic/tugasDE4/stream-platform/schemas/click_event.avsc')
...
def produce():
    ...
    try:
        while True:
            key = str(uuid4())
            value_str = '{"user_id":1,"event_type":"AVRO","ts":"2021-11-8"}'
            value = json.loads(value_str) 

            producer.produce(
            topic = "stock_avro_topic_kharisma",
            key = key,
            value = value,
